...
export function GlassesIcon({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <circle cx="6" cy="14" r="4" strokeWidth="2" />
      <circle cx="18" cy="14" r="4" strokeWidth="2" />
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 14h4M6 10l2-5M18 10l-2-5" />
    </svg>
  );
}
...
export function StarIcon({ className = 'w-5 h-5', fill = 'currentColor' }) {
  return (
...
export function SparklesIcon({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 3v4M3 5h4M6 17v4M4 19h4m9-15v4m-2-2h4m-5 8l1.5 4.5L20 12l-4.5 1.5L14 18l-1.5-4.5L8 12l4.5-1.5L14 6z" />
    </svg>
  );
}
...
export function MicroscopeIcon({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18h12M12 18V9M9 9h6M9 6h6M8 3h8" />
...
export function QuoteIcon({ className = 'w-5 h-5' }) {
  return (
...
export function Loader2Icon({ className = 'w-5 h-5' }) {
  return (
