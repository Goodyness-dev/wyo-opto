  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs sm:text-sm text-slate-500 font-medium mt-0.5">
            Plan, prioritize, and manage patient vision appointments with ease.
          </p>
        </div>
        ...
        <div className="flex items-center space-x-2.5">
          <button
            ...
            className="py-2.5 px-4 bg-[#cb6336] hover:bg-[#b9552b] text-white font-bold text-xs sm:text-sm rounded-xl transition shadow-md shadow-[#6c8572]/20 flex items-center space-x-2 active:scale-95 cursor-pointer"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div 
          onClick={() => onNavigateTab('orders')}
          className="bg-gradient-to-br from-[#6c8572] to-[#5a7260] text-white rounded-3xl p-6 shadow-lg shadow-[#6c8572]/20 cursor-pointer transition hover:scale-[1.01] flex flex-col justify-between"
        >
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold uppercase tracking-wider text-[#e6efe8]">Total Patient Appointments</span>
          ...
          <div className="inline-flex items-center space-x-1.5 text-xs text-[#e6efe8] bg-white/15 px-2.5 py-1 rounded-full w-max font-medium">
            <span>↑ 14%</span>
        ...
        >
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold uppercase tracking-wider text-slate-500">Completed Exams</span>
          ...
          <div className="inline-flex items-center space-x-1.5 text-xs text-emerald-700 bg-emerald-50 border border-emerald-100 px-2.5 py-1 rounded-full w-max font-medium">
            <span>✓ 100%</span>
            <span>satisfied patient visits</span>
          </div>
        </div>
        ...
        <div 
          onClick={() => onNavigateTab('inbox')}
          className="bg-white border border-indigo-100 rounded-3xl p-6 shadow-sm hover:shadow-md transition cursor-pointer flex flex-col justify-between"
        >
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold uppercase tracking-wider text-indigo-600">Pending Requests</span>
            <div className="w-8 h-8 rounded-full border border-indigo-100 bg-indigo-50 flex items-center justify-center hover:opacity-80 transition">
              <ArrowUpRight className="w-4 h-4 text-indigo-600" />
            </div>
          </div>
          <div className="my-4">
            <div className="text-4xl font-black font-heading text-indigo-600">{stats.pending}</div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-5 bg-white border border-slate-200/80 rounded-3xl p-6 shadow-sm flex flex-col justify-between">
          ...
          <div className="flex items-end justify-between gap-3 h-40 pt-4 px-2">
            {[
              ...
              <div key={idx} className="flex-1 flex flex-col items-center h-full justify-end group relative">
                {bar.highlight && (
                  <span className="absolute -top-7 text-[10px] font-bold text-[#cb6336] bg-[#f4f1ea] border border-[#d8d1c4] px-1.5 py-0.5 rounded-full shadow-xs">
                    {bar.highlight}
                  </span>
                )}
                <div 
          ...
          <div className="flex items-center justify-center space-x-6 pt-4 border-t border-slate-100 mt-2 text-xs">
            <span className="flex items-center space-x-2 text-slate-600">
              <span className="w-2.5 h-2.5 rounded-full bg-[#cb6336]" />
        ...
        <div className="lg:col-span-3 bg-white border border-slate-200/80 rounded-3xl p-6 shadow-sm flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between text-xs font-bold text-slate-400 uppercase tracking-wider mb-3">
              ...
              <span className="w-2 h-2 rounded-full bg-[#f4f1ea]0 animate-ping" />
            </div>
            ...
            {urgentOrder ? (
              <div className="space-y-2">
                ...
                <div className="text-xs text-[#cb6336] font-bold">
          ...
          <button
            ...
            className="w-full mt-4 py-3 px-4 bg-[#cb6336] hover:bg-[#b9552b] text-white font-bold text-xs rounded-2xl transition shadow-md shadow-[#6c8572]/20 flex items-center justify-center space-x-2"
          >
        ...
        <div className="lg:col-span-4 bg-white border border-slate-200/80 rounded-3xl p-6 shadow-sm flex flex-col justify-between">
          <div className="flex items-center justify-between mb-3">
            ...
            <button
              onClick={onOpenNewOrder}
              className="text-xs font-bold text-[#cb6336] hover:text-[#b9552b] flex items-center space-x-1 bg-[#f4f1ea] px-2 py-1 rounded-lg"
            >
          ...
          <button
            onClick={() => onNavigateTab('orders')}
            className="w-full text-center text-xs font-bold text-[#cb6336] hover:text-[#b9552b] pt-3 border-t border-slate-100 mt-2 flex items-center justify-center space-x-1"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-5 bg-white border border-slate-200/80 rounded-3xl p-6 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              onClick={() => onNavigateTab('inbox')}
              className="text-xs font-bold text-slate-600 hover:text-[#cb6336] flex items-center space-x-1 border border-slate-200 px-2.5 py-1 rounded-xl"
            >
              ...
              return (
                ...
                >
                  <div className="flex items-center space-x-3 min-w-0">
                    <div className="w-9 h-9 rounded-xl bg-red-100 text-[#b9552b] font-bold text-xs flex items-center justify-center shrink-0">
                      {initials}
                    </div>
        ...
        <div className="lg:col-span-3 bg-white border border-slate-200/80 rounded-3xl p-6 shadow-sm flex flex-col justify-between">
          ...
          <div className="flex items-center justify-between text-[11px] text-slate-500 pt-3 border-t border-slate-100">
            <span className="flex items-center space-x-1">
              <span className="w-2 h-2 rounded-full bg-[#cb6336]" />
              <span>Completed</span>
            </span>
            <span className="flex items-center space-x-1">
